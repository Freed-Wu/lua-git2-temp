...
#define obj_type_id_BlameOptions 0
#define obj_type_BlameOptions (obj_types[obj_type_id_BlameOptions])
  { NULL, 0, OBJ_TYPE_FLAG_WEAK_REF, "BlameOptions" },
#define obj_type_id_BlameHunk 1
#define obj_type_BlameHunk (obj_types[obj_type_id_BlameHunk])
  { NULL, 1, OBJ_TYPE_FLAG_WEAK_REF, "BlameHunk" },
#define obj_type_id_Blame 2
#define obj_type_Blame (obj_types[obj_type_id_Blame])
  { NULL, 2, OBJ_TYPE_FLAG_WEAK_REF, "Blame" },
#define obj_type_id_CheckoutOptions 3
#define obj_type_CheckoutOptions (obj_types[obj_type_id_CheckoutOptions])
  { NULL, 3, OBJ_TYPE_FLAG_WEAK_REF, "CheckoutOptions" },
#define obj_type_id_DiffFindOptions 4
#define obj_type_DiffFindOptions (obj_types[obj_type_id_DiffFindOptions])
  { NULL, 4, OBJ_TYPE_FLAG_WEAK_REF, "DiffFindOptions" },
#define obj_type_id_DiffOptions 5
#define obj_type_DiffOptions (obj_types[obj_type_id_DiffOptions])
  { NULL, 5, OBJ_TYPE_FLAG_WEAK_REF, "DiffOptions" },
#define obj_type_id_DiffDelta 6
#define obj_type_DiffDelta (obj_types[obj_type_id_DiffDelta])
  { NULL, 6, OBJ_TYPE_FLAG_WEAK_REF, "DiffDelta" },
#define obj_type_id_DiffStats 7
#define obj_type_DiffStats (obj_types[obj_type_id_DiffStats])
  { NULL, 7, OBJ_TYPE_FLAG_WEAK_REF, "DiffStats" },
#define obj_type_id_DiffFile 8
#define obj_type_DiffFile (obj_types[obj_type_id_DiffFile])
  { NULL, 8, OBJ_TYPE_FLAG_WEAK_REF, "DiffFile" },
#define obj_type_id_Diff 9
#define obj_type_Diff (obj_types[obj_type_id_Diff])
  { NULL, 9, OBJ_TYPE_FLAG_WEAK_REF, "Diff" },
#define obj_type_id_StatusOptions 10
#define obj_type_StatusOptions (obj_types[obj_type_id_StatusOptions])
  { NULL, 10, OBJ_TYPE_FLAG_WEAK_REF, "StatusOptions" },
#define obj_type_id_StatusList 11
#define obj_type_StatusList (obj_types[obj_type_id_StatusList])
  { NULL, 11, OBJ_TYPE_FLAG_WEAK_REF, "StatusList" },
#define obj_type_id_StatusEntry 12
#define obj_type_StatusEntry (obj_types[obj_type_id_StatusEntry])
  { NULL, 12, OBJ_TYPE_FLAG_WEAK_REF, "StatusEntry" },
#define obj_type_id_StrArray 13
#define obj_type_StrArray (obj_types[obj_type_id_StrArray])
  { NULL, 13, OBJ_TYPE_SIMPLE, "StrArray" },
#define obj_type_id_Repository 14
#define obj_type_Repository (obj_types[obj_type_id_Repository])
  { NULL, 14, OBJ_TYPE_FLAG_WEAK_REF, "Repository" },
#define obj_type_id_Config 15
#define obj_type_Config (obj_types[obj_type_id_Config])
  { NULL, 15, OBJ_TYPE_FLAG_WEAK_REF, "Config" },
#define obj_type_id_OdbObject 16
#define obj_type_OdbObject (obj_types[obj_type_id_OdbObject])
  { NULL, 16, OBJ_TYPE_FLAG_WEAK_REF, "OdbObject" },
#define obj_type_id_OID 17
#define obj_type_OID (obj_types[obj_type_id_OID])
  { NULL, 17, OBJ_TYPE_SIMPLE, "OID" },
#define obj_type_id_OID_Shorten 18
#define obj_type_OID_Shorten (obj_types[obj_type_id_OID_Shorten])
  { NULL, 18, OBJ_TYPE_FLAG_WEAK_REF, "OID_Shorten" },
#define obj_type_id_ODB 19
#define obj_type_ODB (obj_types[obj_type_id_ODB])
  { NULL, 19, OBJ_TYPE_FLAG_WEAK_REF, "ODB" },
#define obj_type_id_ODBBackend 20
#define obj_type_ODBBackend (obj_types[obj_type_id_ODBBackend])
  { NULL, 20, OBJ_TYPE_FLAG_WEAK_REF, "ODBBackend" },
#define obj_type_id_Index 21
#define obj_type_Index (obj_types[obj_type_id_Index])
  { NULL, 21, OBJ_TYPE_FLAG_WEAK_REF, "Index" },
#define obj_type_id_IndexEntry 22
#define obj_type_IndexEntry (obj_types[obj_type_id_IndexEntry])
  { NULL, 22, OBJ_TYPE_FLAG_WEAK_REF, "IndexEntry" },
#define obj_type_id_IndexEntryUnmerged 23
#define obj_type_IndexEntryUnmerged (obj_types[obj_type_id_IndexEntryUnmerged])
  { NULL, 23, OBJ_TYPE_FLAG_WEAK_REF, "IndexEntryUnmerged" },
#define obj_type_id_Object 24
#define obj_type_Object (obj_types[obj_type_id_Object])
  { dyn_caster_Object, 24, OBJ_TYPE_FLAG_WEAK_REF, "Object" },
#define obj_type_id_Blob 25
#define obj_type_Blob (obj_types[obj_type_id_Blob])
  { NULL, 25, OBJ_TYPE_FLAG_WEAK_REF, "Blob" },
#define obj_type_id_Patch 26
#define obj_type_Patch (obj_types[obj_type_id_Patch])
  { NULL, 26, OBJ_TYPE_FLAG_WEAK_REF, "Patch" },
#define obj_type_id_Signature 27
#define obj_type_Signature (obj_types[obj_type_id_Signature])
  { NULL, 27, OBJ_TYPE_FLAG_WEAK_REF, "Signature" },
#define obj_type_id_Commit 28
#define obj_type_Commit (obj_types[obj_type_id_Commit])
  { NULL, 28, OBJ_TYPE_FLAG_WEAK_REF, "Commit" },
#define obj_type_id_Tree 29
#define obj_type_Tree (obj_types[obj_type_id_Tree])
  { NULL, 29, OBJ_TYPE_FLAG_WEAK_REF, "Tree" },
#define obj_type_id_TreeEntry 30
#define obj_type_TreeEntry (obj_types[obj_type_id_TreeEntry])
  { NULL, 30, OBJ_TYPE_FLAG_WEAK_REF, "TreeEntry" },
#define obj_type_id_Tag 31
#define obj_type_Tag (obj_types[obj_type_id_Tag])
  { NULL, 31, OBJ_TYPE_FLAG_WEAK_REF, "Tag" },
#define obj_type_id_RevWalk 32
#define obj_type_RevWalk (obj_types[obj_type_id_RevWalk])
  { NULL, 32, OBJ_TYPE_FLAG_WEAK_REF, "RevWalk" },
#define obj_type_id_Reference 33
#define obj_type_Reference (obj_types[obj_type_id_Reference])
  { NULL, 33, OBJ_TYPE_FLAG_WEAK_REF, "Reference" },
  {NULL, -1, 0, NULL},
};
...
#define obj_type_BlameOptions_check(L, _index) \
	obj_udata_luacheck(L, _index, &(obj_type_BlameOptions))
#define obj_type_BlameOptions_optional(L, _index) \
	obj_udata_luaoptional(L, _index, &(obj_type_BlameOptions))
#define obj_type_BlameOptions_delete(L, _index, flags) \
	obj_udata_luadelete_weak(L, _index, &(obj_type_BlameOptions), flags)
#define obj_type_BlameOptions_push(L, obj, flags) \
	obj_udata_luapush_weak(L, (void *)obj, &(obj_type_BlameOptions), flags)

#define obj_type_BlameHunk_check(L, _index) \
	obj_udata_luacheck(L, _index, &(obj_type_BlameHunk))
#define obj_type_BlameHunk_optional(L, _index) \
	obj_udata_luaoptional(L, _index, &(obj_type_BlameHunk))
#define obj_type_BlameHunk_delete(L, _index, flags) \
	obj_udata_luadelete_weak(L, _index, &(obj_type_BlameHunk), flags)
#define obj_type_BlameHunk_push(L, obj, flags) \
	obj_udata_luapush_weak(L, (void *)obj, &(obj_type_BlameHunk), flags)

#define obj_type_Blame_check(L, _index) \
	obj_udata_luacheck(L, _index, &(obj_type_Blame))
#define obj_type_Blame_optional(L, _index) \
	obj_udata_luaoptional(L, _index, &(obj_type_Blame))
#define obj_type_Blame_delete(L, _index, flags) \
	obj_udata_luadelete_weak(L, _index, &(obj_type_Blame), flags)
#define obj_type_Blame_push(L, obj, flags) \
	obj_udata_luapush_weak(L, (void *)obj, &(obj_type_Blame), flags)
...
#define obj_type_Patch_check(L, _index) \
	obj_udata_luacheck(L, _index, &(obj_type_Patch))
#define obj_type_Patch_optional(L, _index) \
	obj_udata_luaoptional(L, _index, &(obj_type_Patch))
#define obj_type_Patch_delete(L, _index, flags) \
	obj_udata_luadelete_weak(L, _index, &(obj_type_Patch), flags)
#define obj_type_Patch_push(L, obj, flags) \
	obj_udata_luapush_weak(L, (void *)obj, &(obj_type_Patch), flags)
...
/* method: init */
static int BlameOptions__init__meth(lua_State *L) {
  int this_flags_idx1 = OBJ_UDATA_FLAG_OWN;
  BlameOptions * this_idx1;
	this_idx1 = calloc(1, sizeof(BlameOptions));
	git_blame_options_init(this_idx1, GIT_BLAME_OPTIONS_VERSION);

  obj_type_BlameOptions_push(L, this_idx1, this_flags_idx1);
  return 1;
}

/* method: _priv */
static int BlameOptions__delete__meth(lua_State *L) {
  int this_flags_idx1 = 0;
  BlameOptions * this_idx1;
  this_idx1 = obj_type_BlameOptions_delete(L,1,&(this_flags_idx1));
...
/* method: set_flags */
static int BlameOptions__set_flags__meth(lua_State *L) {
  BlameOptions * this_idx1;
  unsigned int flags_idx2;
  this_idx1 = obj_type_BlameOptions_check(L,1);
...
static int BlameOptions__set_min_match_characters__meth(lua_State *L) {
  BlameOptions * this_idx1;
  uint16_t min_match_characters_idx2;
  this_idx1 = obj_type_BlameOptions_check(L,1);
  min_match_characters_idx2 = luaL_checkinteger(L,2);
		this_idx1->min_match_characters = min_match_characters_idx2;

  return 0;
}

/* method: set_newest_commit */
static int BlameOptions__set_newest_commit__meth(lua_State *L) {
  BlameOptions * this_idx1;
  OID id_idx2;
  this_idx1 = obj_type_BlameOptions_check(L,1);
  id_idx2 = obj_type_OID_check(L,2);
		git_oid_cpy(&(this_idx1->newest_commit), &(id_idx2));

  return 0;
}

/* method: set_oldest_commit */
static int BlameOptions__set_oldest_commit__meth(lua_State *L) {
  BlameOptions * this_idx1;
  OID id_idx2;
  this_idx1 = obj_type_BlameOptions_check(L,1);
  id_idx2 = obj_type_OID_check(L,2);
		git_oid_cpy(&(this_idx1->oldest_commit), &(id_idx2));

  return 0;
}

/* method: set_min_line */
static int BlameOptions__set_min_line__meth(lua_State *L) {
  BlameOptions * this_idx1;
  size_t min_line_idx2;
  this_idx1 = obj_type_BlameOptions_check(L,1);
  min_line_idx2 = luaL_checkinteger(L,2);
		this_idx1->min_line = min_line_idx2;

  return 0;
}

/* method: set_max_line */
static int BlameOptions__set_max_line__meth(lua_State *L) {
  BlameOptions * this_idx1;
  size_t max_line_idx2;
  this_idx1 = obj_type_BlameOptions_check(L,1);
  max_line_idx2 = luaL_checkinteger(L,2);
		this_idx1->max_line = max_line_idx2;

  return 0;
}

/* method: flags */
static int BlameOptions__flags__meth(lua_State *L) {
  BlameOptions * this_idx1;
...
/* method: min_match_characters */
static int BlameOptions__min_match_characters__meth(lua_State *L) {
  BlameOptions * this_idx1;
  uint16_t field_idx1 = 0;
  this_idx1 = obj_type_BlameOptions_check(L,1);
	field_idx1 = this_idx1->min_match_characters;
...
/* method: min_line */
static int BlameOptions__min_line__meth(lua_State *L) {
  BlameOptions * this_idx1;
  size_t field_idx1 = 0;
  this_idx1 = obj_type_BlameOptions_check(L,1);
	field_idx1 = this_idx1->min_line;
...
/* method: max_line */
static int BlameOptions__max_line__meth(lua_State *L) {
  BlameOptions * this_idx1;
  size_t field_idx1 = 0;
  this_idx1 = obj_type_BlameOptions_check(L,1);
	field_idx1 = this_idx1->max_line;
...
static int BlameHunk__final_signature__meth(lua_State *L) {
  BlameHunk * this_idx1;
  Signature * sig_idx1;
  this_idx1 = obj_type_BlameHunk_check(L,1);
		sig_idx1 = this_idx1->final_signature;

  obj_type_Signature_push(L, sig_idx1, 0);
  return 1;
}

/* method: final_committer */
static int BlameHunk__final_committer__meth(lua_State *L) {
  BlameHunk * this_idx1;
  Signature * sig_idx1;
  this_idx1 = obj_type_BlameHunk_check(L,1);
		sig_idx1 = this_idx1->final_committer;
...
static int BlameHunk__orig_signature__meth(lua_State *L) {
  BlameHunk * this_idx1;
  Signature * sig_idx1;
  this_idx1 = obj_type_BlameHunk_check(L,1);
		sig_idx1 = this_idx1->orig_signature;
...
static int BlameHunk__orig_committer__meth(lua_State *L) {
  BlameHunk * this_idx1;
  Signature * sig_idx1;
  this_idx1 = obj_type_BlameHunk_check(L,1);
		sig_idx1 = this_idx1->orig_committer;

  obj_type_Signature_push(L, sig_idx1, 0);
  return 1;
}

/* method: lines_in_hunk */
static int BlameHunk__lines_in_hunk__meth(lua_State *L) {
  BlameHunk * this_idx1;
  size_t field_idx1 = 0;
  this_idx1 = obj_type_BlameHunk_check(L,1);
	field_idx1 = this_idx1->lines_in_hunk;

  lua_pushinteger(L, field_idx1);
  return 1;
}

/* method: final_commit_id */
static int BlameHunk__final_commit_id__meth(lua_State *L) {
  BlameHunk * this_idx1;
  OID field_idx1;
  this_idx1 = obj_type_BlameHunk_check(L,1);
	field_idx1 = this_idx1->final_commit_id;

  obj_type_OID_push(L, field_idx1);
  return 1;
}

/* method: final_start_line_number */
static int BlameHunk__final_start_line_number__meth(lua_State *L) {
  BlameHunk * this_idx1;
  size_t field_idx1 = 0;
  this_idx1 = obj_type_BlameHunk_check(L,1);
	field_idx1 = this_idx1->final_start_line_number;

  lua_pushinteger(L, field_idx1);
  return 1;
}

/* method: orig_start_line_number */
static int BlameHunk__orig_start_line_number__meth(lua_State *L) {
  BlameHunk * this_idx1;
  size_t field_idx1 = 0;
  this_idx1 = obj_type_BlameHunk_check(L,1);
	field_idx1 = this_idx1->orig_start_line_number;
...
/* method: orig_path */
static int BlameHunk__orig_path__meth(lua_State *L) {
  BlameHunk * this_idx1;
  const char * field_idx1 = NULL;
  this_idx1 = obj_type_BlameHunk_check(L,1);
	field_idx1 = this_idx1->orig_path;
...
/* method: summary */
static int BlameHunk__summary__meth(lua_State *L) {
  BlameHunk * this_idx1;
  const char * field_idx1 = NULL;
  this_idx1 = obj_type_BlameHunk_check(L,1);
	field_idx1 = this_idx1->summary;
...
/* method: boundary */
static int BlameHunk__boundary__meth(lua_State *L) {
  BlameHunk * this_idx1;
  char field_idx1 = 0;
  this_idx1 = obj_type_BlameHunk_check(L,1);
	field_idx1 = this_idx1->boundary;
...
/* method: file */
static int Blame__file__meth(lua_State *L) {
  Repository * repo_idx1;
  size_t path_len_idx2;
  const char * path_idx2;
  BlameOptions * opts_idx3;
  int this_flags_idx1 = OBJ_UDATA_FLAG_OWN;
  Blame * this_idx1;
  GitError err_idx2 = GIT_OK;
  repo_idx1 = obj_type_Repository_check(L,1);
  path_idx2 = luaL_checklstring(L,2,&(path_len_idx2));
  opts_idx3 = obj_type_BlameOptions_check(L,3);
  err_idx2 = git_blame_file(&(this_idx1), repo_idx1, path_idx2, opts_idx3);
  if(!(GIT_OK != err_idx2)) {
    obj_type_Blame_push(L, this_idx1, this_flags_idx1);
  } else {
    lua_pushnil(L);
  }
...
/* method: _priv */
static int Blame__delete__meth(lua_State *L) {
  int this_flags_idx1 = 0;
  Blame * this_idx1;
  this_idx1 = obj_type_Blame_delete(L,1,&(this_flags_idx1));
  if(!(this_flags_idx1 & OBJ_UDATA_FLAG_OWN)) { return 0; }
  git_blame_free(this_idx1);
  return 0;
}

/* method: count */
static int Blame__count__meth(lua_State *L) {
  Blame * this_idx1;
  size_t count_idx1 = 0;
  this_idx1 = obj_type_Blame_check(L,1);
  count_idx1 = git_blame_hunkcount(this_idx1);
  lua_pushinteger(L, count_idx1);
  return 1;
}

/* method: linecount */
static int Blame__linecount__meth(lua_State *L) {
  Blame * this_idx1;
  size_t count_idx1 = 0;
  this_idx1 = obj_type_Blame_check(L,1);
		size_t hunk_count = git_blame_hunkcount(this_idx1);
		size_t idx;
		count_idx1 = 0;

		for (idx = 0; idx < hunk_count; idx++) {
			const git_blame_hunk *hunk = git_blame_get_hunk_byindex(this_idx1, idx);
			if (hunk != NULL) {
				size_t last_line = hunk->final_start_line_number + hunk->lines_in_hunk - 1;
				if (last_line > count_idx1) {
					count_idx1 = last_line;
				}
			}
		}
...
/* method: buffer */
static int Blame__buffer__meth(lua_State *L) {
  Blame * this_idx1;
  this_idx1 = obj_type_Blame_check(L,1);
...
static int Blame__get_hunk_byindex__meth(lua_State *L) {
  Blame * this_idx1;
  size_t index_idx2;
  BlameHunk * hunk_idx1;
  this_idx1 = obj_type_Blame_check(L,1);
  index_idx2 = luaL_checkinteger(L,2);
		hunk_idx1 = (BlameHunk *)git_blame_get_hunk_byindex(this_idx1, index_idx2);

  obj_type_BlameHunk_push(L, hunk_idx1, 0);
  return 1;
}

/* method: get_hunk_byline */
static int Blame__get_hunk_byline__meth(lua_State *L) {
  Blame * this_idx1;
  size_t linenum_idx2;
  BlameHunk * hunk_idx1;
  this_idx1 = obj_type_Blame_check(L,1);
  linenum_idx2 = luaL_checkinteger(L,2);
		hunk_idx1 = (BlameHunk *)git_blame_get_hunk_byline(this_idx1, linenum_idx2);
...
/* method: to_buf */
static int Diff__to_buf__meth(lua_State *L) {
  Diff * this_idx1;
  unsigned int format_idx2;
  this_idx1 = obj_type_Diff_check(L,1);
  format_idx2 = luaL_checkinteger(L,2);
		git_buf out = GIT_BUF_INIT;
		int rc = git_diff_to_buf(&out, this_idx1, format_idx2);
		if (rc < 0) {
...
/* method: from_workdir */
static int Blob__from_workdir__func(lua_State *L) {
  Repository * repo_idx1;
  size_t relative_path_len_idx2;
  const char * relative_path_idx2;
  OID written_id_idx1;
  GitError err_idx2 = GIT_OK;
  repo_idx1 = obj_type_Repository_check(L,1);
  relative_path_idx2 = luaL_checklstring(L,2,&(relative_path_len_idx2));
  err_idx2 = git_blob_create_from_workdir(&(written_id_idx1), repo_idx1, relative_path_idx2);
  if(!(GIT_OK != err_idx2)) {
    obj_type_OID_push(L, written_id_idx1);
  } else {
    lua_pushnil(L);
...
/* method: from_diff */
static int Patch__from_diff__meth(lua_State *L) {
  Diff * diff_idx1;
  size_t idx_idx2;
  int this_flags_idx1 = OBJ_UDATA_FLAG_OWN;
  Patch * this_idx1;
  ...
  diff_idx1 = obj_type_Diff_check(L,1);
  idx_idx2 = luaL_checkinteger(L,2);
  err_idx2 = git_patch_from_diff(&(this_idx1), diff_idx1, idx_idx2);
  if(!(GIT_OK != err_idx2)) {
    obj_type_Patch_push(L, this_idx1, this_flags_idx1);
  } else {
    lua_pushnil(L);
  }
  error_code__GitError__push(L, err_idx2);
...
/* method: from_buffers */
static int Patch__from_buffers__meth(lua_State *L) {
  size_t old_buffer_len_idx1;
  const char * old_buffer_idx1;
  size_t old_len_idx2;
  size_t old_path_len_idx3;
  const char * old_path_idx3;
  size_t new_buffer_len_idx4;
  const char * new_buffer_idx4;
  size_t new_len_idx5;
  size_t new_path_len_idx6;
  const char * new_path_idx6;
  DiffOptions * opts_idx7;
  int this_flags_idx1 = OBJ_UDATA_FLAG_OWN;
  Patch * this_idx1;
  GitError err_idx2 = GIT_OK;
  old_buffer_idx1 = luaL_checklstring(L,1,&(old_buffer_len_idx1));
  old_len_idx2 = luaL_checkinteger(L,2);
  old_path_idx3 = luaL_checklstring(L,3,&(old_path_len_idx3));
  new_buffer_idx4 = luaL_checklstring(L,4,&(new_buffer_len_idx4));
  new_len_idx5 = luaL_checkinteger(L,5);
  new_path_idx6 = luaL_checklstring(L,6,&(new_path_len_idx6));
  opts_idx7 = obj_type_DiffOptions_check(L,7);
  err_idx2 = git_patch_from_buffers(&(this_idx1), old_buffer_idx1, old_len_idx2, old_path_idx3, new_buffer_idx4, new_len_idx5, new_path_idx6, opts_idx7);
  if(!(GIT_OK != err_idx2)) {
    obj_type_Patch_push(L, this_idx1, this_flags_idx1);
  } else {
    lua_pushnil(L);
...
/* method: _priv */
static int Patch__delete__meth(lua_State *L) {
  int this_flags_idx1 = 0;
  Patch * this_idx1;
  this_idx1 = obj_type_Patch_delete(L,1,&(this_flags_idx1));
  if(!(this_flags_idx1 & OBJ_UDATA_FLAG_OWN)) { return 0; }
  git_patch_free(this_idx1);
  return 0;
}

/* method: num_hunks */
static int Patch__num_hunks__meth(lua_State *L) {
  Patch * this_idx1;
  size_t count_idx1 = 0;
  this_idx1 = obj_type_Patch_check(L,1);
  count_idx1 = git_patch_num_hunks(this_idx1);
  lua_pushinteger(L, count_idx1);
  return 1;
}

/* method: num_lines */
static int Patch__num_lines__meth(lua_State *L) {
  Patch * this_idx1;
  size_t hunk_idx_idx2;
  size_t count_idx1 = 0;
  this_idx1 = obj_type_Patch_check(L,1);
  hunk_idx_idx2 = luaL_checkinteger(L,2);
  count_idx1 = git_patch_num_lines_in_hunk(this_idx1, hunk_idx_idx2);
  lua_pushinteger(L, count_idx1);
  return 1;
}

/* method: line_origin */
static int Patch__line_origin__meth(lua_State *L) {
  Patch * this_idx1;
  size_t hunk_idx_idx2;
  size_t line_idx_idx3;
  this_idx1 = obj_type_Patch_check(L,1);
  hunk_idx_idx2 = luaL_checkinteger(L,2);
  line_idx_idx3 = luaL_checkinteger(L,3);
	const git_diff_line *line;
	int rc = git_patch_get_line_in_hunk(&line, this_idx1, hunk_idx_idx2, line_idx_idx3);
	if (rc < 0) {
		lua_pushnil(L);
	} else {
...
static const luaL_Reg obj_BlameOptions_pub_funcs[] = {
  {"init", BlameOptions__init__meth},
  {NULL, NULL}
};

static const luaL_Reg obj_BlameOptions_methods[] = {
  {"set_flags", BlameOptions__set_flags__meth},
  {"set_min_match_characters", BlameOptions__set_min_match_characters__meth},
  {"set_newest_commit", BlameOptions__set_newest_commit__meth},
  {"set_oldest_commit", BlameOptions__set_oldest_commit__meth},
  {"set_min_line", BlameOptions__set_min_line__meth},
  {"set_max_line", BlameOptions__set_max_line__meth},
  {"flags", BlameOptions__flags__meth},
  {"min_match_characters", BlameOptions__min_match_characters__meth},
  {"min_line", BlameOptions__min_line__meth},
  {"max_line", BlameOptions__max_line__meth},
  {NULL, NULL}
};

static const luaL_Reg obj_BlameOptions_metas[] = {
  {"__gc", BlameOptions__delete__meth},
  {"__tostring", obj_udata_default_tostring},
  {"__eq", obj_udata_default_equal},
  {NULL, NULL}
};

static const obj_base obj_BlameOptions_bases[] = {
  {-1, NULL}
};

static const obj_field obj_BlameOptions_fields[] = {
  {NULL, 0, 0, 0}
};

static const obj_const obj_BlameOptions_constants[] = {
  {"TRACK_COPIES_SAME_COMMIT_COPIES", NULL, 4, CONST_NUMBER},
  {"IGNORE_WHITESPACE", NULL, 64, CONST_NUMBER},
  {"NORMAL", NULL, 0, CONST_NUMBER},
  {"TRACK_COPIES_SAME_COMMIT_MOVES", NULL, 2, CONST_NUMBER},
  {"FIRST_PARENT", NULL, 16, CONST_NUMBER},
  {"USE_MAILMAP", NULL, 32, CONST_NUMBER},
  {"TRACK_COPIES_ANY_COMMIT_COPIES", NULL, 8, CONST_NUMBER},
  {"TRACK_COPIES_SAME_FILE", NULL, 1, CONST_NUMBER},
  {NULL, NULL, 0.0 , 0}
};

static const reg_impl obj_BlameOptions_implements[] = {
  {NULL, NULL}
};

static const luaL_Reg obj_BlameHunk_pub_funcs[] = {
  {NULL, NULL}
};

static const luaL_Reg obj_BlameHunk_methods[] = {
  {"final_signature", BlameHunk__final_signature__meth},
  {"final_committer", BlameHunk__final_committer__meth},
  {"orig_signature", BlameHunk__orig_signature__meth},
  {"orig_committer", BlameHunk__orig_committer__meth},
  {"lines_in_hunk", BlameHunk__lines_in_hunk__meth},
  {"final_commit_id", BlameHunk__final_commit_id__meth},
  {"final_start_line_number", BlameHunk__final_start_line_number__meth},
  {"orig_start_line_number", BlameHunk__orig_start_line_number__meth},
  {"orig_path", BlameHunk__orig_path__meth},
  {"summary", BlameHunk__summary__meth},
  {"boundary", BlameHunk__boundary__meth},
  {NULL, NULL}
};

static const luaL_Reg obj_BlameHunk_metas[] = {
  {"__tostring", obj_udata_default_tostring},
  {"__eq", obj_udata_default_equal},
  {NULL, NULL}
};

static const obj_base obj_BlameHunk_bases[] = {
  {-1, NULL}
};

static const obj_field obj_BlameHunk_fields[] = {
  {NULL, 0, 0, 0}
};

static const obj_const obj_BlameHunk_constants[] = {
  {NULL, NULL, 0.0 , 0}
};

static const reg_impl obj_BlameHunk_implements[] = {
  {NULL, NULL}
};

static const luaL_Reg obj_Blame_pub_funcs[] = {
  {"file", Blame__file__meth},
  {NULL, NULL}
};

static const luaL_Reg obj_Blame_methods[] = {
  {"count", Blame__count__meth},
  {"linecount", Blame__linecount__meth},
  {"buffer", Blame__buffer__meth},
  {"get_hunk_byindex", Blame__get_hunk_byindex__meth},
  {"get_hunk_byline", Blame__get_hunk_byline__meth},
  {NULL, NULL}
};

static const luaL_Reg obj_Blame_metas[] = {
  {"__gc", Blame__delete__meth},
  {"__tostring", obj_udata_default_tostring},
  {"__eq", obj_udata_default_equal},
  {NULL, NULL}
};

static const obj_base obj_Blame_bases[] = {
  {-1, NULL}
};

static const obj_field obj_Blame_fields[] = {
  {NULL, 0, 0, 0}
};

static const obj_const obj_Blame_constants[] = {
  {NULL, NULL, 0.0 , 0}
};

static const reg_impl obj_Blame_implements[] = {
  {NULL, NULL}
};
...
static const obj_const obj_Diff_constants[] = {
  {"FORMAT_PATCH_HEADER", NULL, 2, CONST_NUMBER},
  {"FORMAT_NAME_ONLY", NULL, 4, CONST_NUMBER},
  {"FORMAT_PATCH", NULL, 1, CONST_NUMBER},
  {"FORMAT_RAW", NULL, 3, CONST_NUMBER},
  {"FORMAT_NAME_STATUS", NULL, 5, CONST_NUMBER},
  {NULL, NULL, 0.0 , 0}
};
...
static const luaL_Reg obj_Blob_pub_funcs[] = {
  ...
  {"from_workdir", Blob__from_workdir__func},
  {NULL, NULL}
};
...
static const luaL_Reg obj_Patch_pub_funcs[] = {
  {"from_diff", Patch__from_diff__meth},
  {"from_buffers", Patch__from_buffers__meth},
  {NULL, NULL}
};

static const luaL_Reg obj_Patch_methods[] = {
  {"num_hunks", Patch__num_hunks__meth},
  {"num_lines", Patch__num_lines__meth},
  {"line_origin", Patch__line_origin__meth},
  {NULL, NULL}
};

static const luaL_Reg obj_Patch_metas[] = {
  {"__gc", Patch__delete__meth},
  {"__tostring", obj_udata_default_tostring},
  {"__eq", obj_udata_default_equal},
  {NULL, NULL}
};

static const obj_base obj_Patch_bases[] = {
  {-1, NULL}
};

static const obj_field obj_Patch_fields[] = {
  {NULL, 0, 0, 0}
};

static const obj_const obj_Patch_constants[] = {
  {NULL, NULL, 0.0 , 0}
};

static const reg_impl obj_Patch_implements[] = {
  {NULL, NULL}
};
...
static const reg_sub_module reg_sub_modules[] = {
  { &(obj_type_BlameOptions), REG_OBJECT, obj_BlameOptions_pub_funcs, obj_BlameOptions_methods, obj_BlameOptions_metas, obj_BlameOptions_bases, obj_BlameOptions_fields, obj_BlameOptions_constants, obj_BlameOptions_implements, 0},
  { &(obj_type_BlameHunk), REG_OBJECT, obj_BlameHunk_pub_funcs, obj_BlameHunk_methods, obj_BlameHunk_metas, obj_BlameHunk_bases, obj_BlameHunk_fields, obj_BlameHunk_constants, obj_BlameHunk_implements, 0},
  { &(obj_type_Blame), REG_OBJECT, obj_Blame_pub_funcs, obj_Blame_methods, obj_Blame_metas, obj_Blame_bases, obj_Blame_fields, obj_Blame_constants, obj_Blame_implements, 0},
  ...
  { &(obj_type_Patch), REG_OBJECT, obj_Patch_pub_funcs, obj_Patch_methods, obj_Patch_metas, obj_Patch_bases, obj_Patch_fields, obj_Patch_constants, obj_Patch_implements, 0},
